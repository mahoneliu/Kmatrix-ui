...
-- 外链类型
UPDATE `sys_menu` SET `menu_name` = 'KMatrix', `order_num` = 100, `path` = 'https://gitee.com/kyxxjs/kmatrix-service', `component` = 'FrameView', `icon` = 'local-icon-gitee', `remark` = 'KMatrix 仓库地址' WHERE `menu_id` = 4;
