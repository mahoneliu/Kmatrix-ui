...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "ai_chunk-manager": () => import("@/views/ai/chunk-manager/index.vue"),
  "ai_datasource-manager": () => import("@/views/ai/datasource-manager/index.vue"),
  "ai_document-upload": () => import("@/views/ai/document-upload/index.vue"),
  "ai_document-upload_step1": () => import("@/views/ai/document-upload/step1/index.vue"),
  "ai_document-upload_step2": () => import("@/views/ai/document-upload/step2/index.vue"),
  "ai_knowledge-detail": () => import("@/views/ai/knowledge-detail/index.vue"),
  "ai_knowledge-manager": () => import("@/views/ai/knowledge-manager/index.vue"),
  ...
  "ai_workflow-template": () => import("@/views/ai/workflow-template/index.vue"),
