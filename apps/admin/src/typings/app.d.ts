      ...
      ai: {
        ...
        app_detail: {
          ...
          ui_setting: {
            ...
            hero: string;
            hero_title: string;
            hero_title_ph: string;
            hero_subtitle: string;
            hero_subtitle_ph: string;
            hero_image: string;
            hero_upload: string;
            hero_replace: string;
            hero_remove: string;
            hero_upload_tip: string;
            hero_upload_success: string;
            hero_upload_failed: string;
            hero_upload_image_only: string;
            features: string;
            features_hint: string;
            add_feature: string;
            features_empty: string;
            features_max: string;
            remove: string;
            move_up: string;
            move_down: string;
            feature_card_label: string;
            feature_title_placeholder: string;
            feature_icon_pick: string;
            feature_icon_custom: string;
            feature_icon_custom_ph: string;
            feature_title: string;
            feature_title_ph: string;
            feature_desc: string;
            feature_desc_ph: string;
            feature_input_prompt: string;
            feature_input_prompt_ph: string;
            suggested_questions: string;
            suggested_questions_hint: string;
            suggested_add: string;
            suggested_question_input_ph: string;
            json_placeholder: string;
            json_invalid: string;
            save_btn: string;
            save_success: string;
            save_failed: string;
            save_need_name: string;
          };
