  ...
  ai: {
    ...
    app_detail: {
      ...
      ui_setting: {
        ...
        hero: 'Hero',
        hero_title: 'Title',
        hero_title_ph: 'e.g. Hello! I am your AI assistant',
        hero_subtitle: 'Subtitle',
        hero_subtitle_ph: 'Short tagline',
        hero_image: 'Hero image',
        hero_upload: 'Upload hero image',
        hero_replace: 'Replace image',
        hero_remove: 'Remove image',
        hero_upload_tip: 'PNG / JPG / GIF / WebP / SVG via system OSS. Save to apply in chat.',
        hero_upload_success: 'Image uploaded',
        hero_upload_failed: 'Upload failed',
        hero_upload_image_only: 'Please choose an image file',
        features: 'Feature cards',
        features_hint: 'Optional shortcuts (often 2×2). Reorder, pick an icon, or type a custom id.',
        add_feature: 'Add card',
        features_empty: 'No cards yet. Click “Add card” to create shortcuts.',
        features_max: 'At most {n} feature cards',
        remove: 'Remove',
        move_up: 'Move up',
        move_down: 'Move down',
        feature_card_label: 'Card {n}',
        feature_title_placeholder: 'Untitled',
        feature_icon_pick: 'Quick pick icon',
        feature_icon_custom: 'Custom icon',
        feature_icon_custom_ph: 'e.g. mdi:camera or a local icon name for SvgIcon',
        feature_title: 'Title',
        feature_title_ph: 'e.g. Identify plants',
        feature_desc: 'Description',
        feature_desc_ph: 'Short subtitle (one or two lines)',
        feature_input_prompt: 'Prompt to fill on card click',
        feature_input_prompt_ph:
          'Optional. When set, this full text is placed in the input. Otherwise title is used, then description.',
        suggested_questions: 'Suggested questions',
        suggested_questions_hint: 'Quick prompts for welcome/chat (max {n}). Empty rows are dropped on save.',
        suggested_add: 'Add question',
        suggested_question_input_ph: 'e.g. How do I care for Phalaenopsis?',
        json_placeholder: 'JSON matching AppUiSetting',
        json_invalid: 'Invalid JSON',
        save_btn: 'Save UI config',
        save_success: 'UI config saved',
        save_failed: 'Save failed',
        save_need_name: 'App name is required'
      },
