...
const workflow_node: App.I18n.Schema['ai']['workflow_node'] = {
  ...
  session_variable_assign: '会话变量赋值',
  variable: '变量',
  assign_mode: '操作模式',
  assign_mode_overwrite: '覆写',
  assign_mode_clear: '清除',
  assign_mode_set: '设置',
  add_variable: '添加变量',
  source_data: '设置参数...',
  select_session_variable: '选择会话变量...',
  no_session_variable_defined: '未定义会话变量，请先在 AppInfo 节点中配置会话参数',
  fixed_value: '固定值',
  parameter_extractor: {
