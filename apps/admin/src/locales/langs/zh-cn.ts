const local: App.I18n.Schema = {
  ...
  ai: {
    ...
    workflow_node: {
      ...
      eg_professional_assistant: '例如:你是一个专业的客服助手... (输入 / 选择变量)',
      eg_analyze_problem: '例如:请帮我分析这个问题... (输入 / 选择变量)',
      ...
      define_ai_role: '定义AI助手的角色 and 行为规范,输入 / 选择变量',
      ...
      user_name: '用户名称',
      user_prompt_desc: '用户向大模型提出的具体问题或指令,输入 / 选择变量',
      type: '类型',
      custom_parameters: '自定义参数',
      custom_output: '自定义输出',
      merge_node_desc: '该节点可以汇合各节点参数，定义特定的内容端，可以通过输入/来引用输入参数的值。',
      input_reply_content: '输入指定的回复文本内容 (输入 / 选择变量)',
      input_end_node_content: '输入结束节点的指定内容作为最终输出 (输入 / 选择变量)',
      ...
      input_or_select_variable: '输入或选择变量',
      unknown_type: '未知类型',
      copied_ref: '引用已复制',
