...
const fallbackConnectionRules: Record<string, string[]> = {
  START: ['LLM_CHAT', 'INTENT_CLASSIFIER', 'CONDITION', 'FIXED_RESPONSE', 'DB_QUERY'],
  LLM_CHAT: ['END', 'LLM_CHAT', 'CONDITION', 'FIXED_RESPONSE', 'DB_QUERY'],
  INTENT_CLASSIFIER: ['LLM_CHAT', 'CONDITION', 'FIXED_RESPONSE', 'END', 'DB_QUERY'],
  CONDITION: ['LLM_CHAT', 'FIXED_RESPONSE', 'END', 'DB_QUERY'],
